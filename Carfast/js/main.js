document.addEventListener("DOMContentLoaded", function(event) { 
    var htmlWrap = document.querySelector("html"),
        ...
        WrapMeNU = document.querySelector("#fix-burger"),
        FixMenu = document.querySelector(".menu-fixed"),
        CloseFixMenu = document.querySelector(".close_menu");

      WrapMeNU.addEventListener('click', function(e){
        FixMenu.classList.add("block-show");
    });
          CloseFixMenu.addEventListener('click', function(e){
        FixMenu.classList.remove("block-show");
    });
